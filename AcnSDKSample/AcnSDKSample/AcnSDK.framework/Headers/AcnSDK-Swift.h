...
SWIFT_CLASS("_TtC6AcnSDK17IotConnectService")
@interface IotConnectService : NSObject
@property (nonatomic) NSInteger sendingDevicesCount;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) IotConnectService * _Nonnull sharedInstance;)
+ (IotConnectService * _Nonnull)sharedInstance;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (void)setupConnectionWithHttp:(NSString * _Nonnull)http mqtt:(NSString * _Nonnull)mqtt mqttPort:(uint16_t)mqttPort mqttVHost:(NSString * _Nonnull)mqttVHost;
- (void)setKeysWithApiKey:(NSString * _Nonnull)apiKey secretKey:(NSString * _Nonnull)secretKey;
- (void)connectMQTTWithGatewayId:(NSString * _Nonnull)gatewayId;
- (void)checkinGatewayWithHid:(NSString * _Nonnull)hid completionHandler:(void (^ _Nonnull)(BOOL))completionHandler;
- (void)gatewayConfigWithHid:(NSString * _Nonnull)hid completionHandler:(void (^ _Nonnull)(BOOL))completionHandler;
- (void)sendPropertyChangeAcknowledgeWithHid:(NSString * _Nonnull)hid;
- (void)sendPropertyChangeSuccessfulWithHid:(NSString * _Nonnull)hid;
- (void)sendPropertyChangeFailureWithHid:(NSString * _Nonnull)hid;
- (void)startHeartbeatWithInterval:(double)interval gatewayId:(NSString * _Nonnull)gatewayId;
- (void)stopHeartbeat;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) IotDataPublisher * _Nonnull sharedInstance;)
+ (IotDataPublisher * _Nonnull)sharedInstance;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (void)start;
...
@interface NSNumber (SWIFT_EXTENSION(AcnSDK))
@end
...
@interface UIDevice (SWIFT_EXTENSION(AcnSDK))
+ (NSString * _Nonnull)UUID;
@end


@interface NSURLSession (SWIFT_EXTENSION(AcnSDK))
@end
